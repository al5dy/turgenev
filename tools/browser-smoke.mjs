...
try {
	...
	for ( const [ file, results, expected ] of [ [ 'highlight-flow.js', 'smokeResults', 11 ], [ 'classic-flow.js', 'classicSmokeResults', 11 ], [ 'mapping-flow.js', 'mappingSmokeResults', 5 ], [ 'saved-post-flow.js', 'savedPostSmokeResults', 4 ], [ 'template-flow.js', 'templateSmokeResults', 9 ] ] ) {
