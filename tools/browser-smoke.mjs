...
try {
	...
	for ( const [ file, results, expected ] of [ [ 'highlight-flow.js', 'smokeResults', 13 ], [ 'classic-flow.js', 'classicSmokeResults', 12 ], [ 'mapping-flow.js', 'mappingSmokeResults', 5 ], [ 'saved-post-flow.js', 'savedPostSmokeResults', 4 ], [ 'template-flow.js', 'templateSmokeResults', 9 ] ] ) {
