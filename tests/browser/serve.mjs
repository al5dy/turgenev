...
<script>window.TurgenevConfig={ajaxUrl:'/analysis',nonce:'smoke-nonce',reportBaseUrl:'https://turgenev.ashmanov.com/?t=',isConfigured:true,maxTextLength:50000,postId:42,settingsUrl:'/settings',topUpUrl:'https://turgenev.ashmanov.com/?a=pay',highlightsAvailable:true};</script>
