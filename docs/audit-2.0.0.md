...
| High | No nonce/capability boundary existed around paid analysis requests. | The browser-side integration had no WordPress request authorization layer of its own. | `wp_ajax_turgenev_api` requires nonce plus `edit_posts`/`manage_options`. |
